...
#     # Only log if not in the middle of executing the log command itself
#     if [[ "$cmd" != *"shelldog"* ]] && [[ "$cmd" != *"_shelldog_"* ]]; then
...
#     preexec() {{
#         "{python_exec}" "{self.logger_script}" "$1" 2>/dev/null &
#     }}
# fi
...
# # Friendly message
# echo "🐕 Woof! Shelldog is now watching your commands silently..."
# '''
